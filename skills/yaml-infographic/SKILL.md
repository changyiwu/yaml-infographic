...
- Use `yaml_spec` planning and one of the bundled versioned profiles unless the user explicitly supplies another style. Pick by publishing surface: `global:paper_warm@1.2.0` for printed handouts and bright rooms, `global:tech_calm@1.0.0` for dark-room screens and social posts.
...
|---|---|---|---|
| `global:paper_warm@1.2.0` (default) | `paper-warm.yaml` | Thick die-cut stickers lifting off a warm gradient ground scattered with sparse low-contrast accents; ink-grey text, amber keywords, red for the single top emphasis | `paper-warm-sample.png` |
